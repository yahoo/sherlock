...
public class DruidQueryServiceTest {
    ...
    public void testBuildWithValidQuery() throws Exception {
        ...
        Assert.assertEquals(druidQueryService.build(queryString, Granularity.DAY, null, null).getMetricNames(), Collections.singletonList("m1"));
    }
    ...
    public void testBuildWithInvalidDruidQuery() throws IOException {
        ...
        try {
            druidQueryService.build(badQueryString, Granularity.DAY, null, null);
            Assert.fail();
        } catch (Exception e) {
    ...
    public void testBuildWithInvalidQuerySyntax() throws Throwable {
        try {
            druidQueryService.build("{}{}{}{{{}}}{}}", Granularity.DAY, null, null);
            Assert.fail();
        } catch (Exception e) {
